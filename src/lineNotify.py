...
BRIAN_API_KEY = "8jxKWOdikn1dwNR8jejCyYk0iHYEhTQz2ZyujEgvXWK"
...
class LineNotify:
    def __init__(self, api_key) -> None:
        """
        Initialize LineNotify instance.

        Args:
            api_key (str): Line Notify API key.
        """
    ...
    def send_image(self, image_path, description):
        """
        Send an image using Line Notify.
        ...
        try:
            ...
            with open(image_path, "rb") as image_file:
                ...
                response = requests.post(
                    api_endpoint, headers=self.header, files=files)
    ...
    def send_message(self, message):
        """
        Send a text message using Line Notify.
